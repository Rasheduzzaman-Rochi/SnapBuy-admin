      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 md:p-12">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-24 h-24 bg-gradient-to-br from-amber-100 to-amber-50 rounded-2xl flex items-center justify-center">
          ...
          {/* Info Box */}
          <div className="bg-gradient-to-r from-blue-50 to-blue-50 border border-blue-200 rounded-xl p-4 mb-8">
          ...
          <div className="mb-8 space-y-3">
            <div className="flex gap-4">
              ...
              <div className="pb-4">
                ...
                <p className="text-sm text-slate-600">Your seller profile has been created</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">You'll receive email confirmation and can login</p>
              </div>
            </div>
          </div>
